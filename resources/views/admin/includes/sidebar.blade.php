    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                    ...
                    <span class="badge badge badge-info badge-pill float-right mr-2"> {{ App\Models\Language::count() }}
                    </span>
                </a>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\MainCategory::defaultLanguages()->count() }}
                    </span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <span
                    class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\subCategory::defaultLanguages()->count() }}
                </span>
            </a>
            <ul class="menu-content">
